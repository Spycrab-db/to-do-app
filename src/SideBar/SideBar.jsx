                ...
                {todoLists.map((list) => {
                    return (
                        <List
                            ...
                            className={`${currList && list.id === currList.id ? "selected" : ""}`}
                        >
                            {list.title}
                        </List>
                    )
